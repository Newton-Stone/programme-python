...
On utilise les données du programme contenues dans donnees_pendu.py"""
...
def recup_scores():
    ...
    On s'appuie sur nom_fichier_scores dÃ©fini dans donnees_pendu.py"""
...
def recup_nom_utilisateur():
    ...
    Le nom de l'utilisateur doit être composé de 2 caractère minimum,
